<?php
/**
 * Refactored from the original excel_reader2.php byby Vadim Tkachenko
    ...
    function _parsesheet($spos) {
        ...
        function _getCellDetails($spos,$numValue,$column) {
            ...
            if ($type == 'date') {
                ...
                $string = new \DateTime();
                $string->setTimestamp(mktime($hours, $mins, $secs, $dateinfo["mon"], $dateinfo["mday"], $dateinfo["year"]));
            } else if ($type == 'number') {
                $rectype = 'number';
