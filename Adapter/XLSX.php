 ...
 */
namespace SpreadsheetReader\Adapter;

class XLSX implements \Iterator, \Countable
{
    ...
    public function __construct($Filepath, array $Options = null)
    {
        ...
        if ($Status !== true)
        {
            throw new \Exception('File not readable ('.$Filepath.') (Error '.$Status.')');
        }
